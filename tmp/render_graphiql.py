""" Make GraphiQL offline possible

This is a modified copy from /site-packages/flask_graphql/render_graphiql.py and altered
to make use of static copies of resources used by GraphiQL.

To use, override your /site-packages/flask_graphql/render_graphiql.py with this one.
